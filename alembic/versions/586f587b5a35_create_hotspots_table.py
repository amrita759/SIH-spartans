...
Revision ID: 586f587b5a35
Revises: 
Create Date: 2026-09-07 20:28:20.123660
...
def upgrade() -> None:
    ...
    sa.Column('center_point', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, from_text='ST_GeomFromEWKT', name='geometry', nullable=False), nullable=False),
    ...
    op.create_index('idx_hotspots_center_point', 'hotspots', ['center_point'], unique=False, postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_hotspots_center_point', table_name='hotspots', postgresql_using='gist')
